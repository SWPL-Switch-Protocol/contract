 ...
 * @notice This contract issues SoulBound Tokens (SBT) for proof of transaction.
 * @dev Implementation of non-transferable NFT (SBT).
 *      Based on OpenZeppelin v5.0.0+ ERC721.
 */
contract SBTCredential is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    uint256 private _nextTokenId;
    string public constant description = "This SoulBound Token (SBTC) for credential.";
