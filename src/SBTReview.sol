 ...
 */
contract SBTReview is ERC721, ERC721URIStorage, Ownable {
    uint256 private _nextTokenId;
    string public constant description = "This SoulBound Token (SBTR) serves as a proof of review.";

    constructor(address initialOwner) ERC721("SBTReview", "SBTR") Ownable(initialOwner) {}
